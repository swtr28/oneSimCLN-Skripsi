 ...
 */
public class MessageStatsReportBaru extends Report implements MessageListener {
    ...
    private int nrofDroppedTTLExpired;

    /**
     * Constructor.
     */
    public MessageStatsReportBaru() {
        init();
    }
    ...
    public void done() {
        ...
        String statsText = "created: " + this.nrofCreated
                ...
                + "\ndropped_buffer_full: " + nrofDroppedBufferFull
                + "\ndropped_ttl_expired: " + nrofDroppedTTLExpired
    ...
    public int getNrofDropped() {
        return nrofDropped;
    }

    public void setNrofDropped(int nrofDropped) {
        this.nrofDropped = nrofDropped;
    }
    ...
    public void setNrofCreated(int nrofCreated) {
        this.nrofCreated = nrofCreated;
    }
